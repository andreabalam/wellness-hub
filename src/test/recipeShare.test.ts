...
const RECIPE: Recipe = {
  id: 42,
  cat: 'breakfast', type: 'Breakfast', color: 'var(--green)', sc: 'sc-green',
  name: 'Avocado Toast', tag: 'Quick · high-protein',
  prepL: '10 min', prepC: 'var(--green)', prepTime: '10 min',
  hk: 320, hp: '8g', hc: '30g', hf: '18g', hfi: '6g',
  mk: 320, mp: '8g', mc: '30g', mf: '18g',
  ings: [['Avocado', '1'], ['Sourdough', '2 slices']],
  steps: ['Mash avocado', 'Toast bread', 'Combine'],
  tip: 'Add chilli flakes',
  custom: true, source: 'user', defaultId: 7, hidden: true,
  dietTag: 'vegetarian',
}
