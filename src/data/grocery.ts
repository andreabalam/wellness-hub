...
export const GROCERY_DATA: Record<string, GroceryItem[]> = {
  'Produce - Vegetables': [
    ...
    { n: 'Arugula or mixed greens',  t: 'add', nutri: { srv: '1 cup',  cal: 5,  p: 0.5, c: 0.7, f: 0.1, fi: 0.3 } },
    { n: 'Cauliflower rice frozen',  t: 'add', nutri: { srv: '1 cup', cal: 25,  p: 2.0, c: 5.0, f: 0.3, fi: 2.0 } },
    { n: 'Frozen edamame',           t: 'add', nutri: { srv: '½ cup shelled', cal: 94, p: 8.4, c: 7.4, f: 4.0, fi: 3.8 } },
  ],
  'Produce - Fruit': [
  ...
  'Protein - Animal': [
    ...
    { n: 'Canned tuna in water',   t: 'add', nutri: { srv: '3 oz drained',  cal: 109, p: 24,  c: 0.0, f: 2.5 } },
    { n: 'Canned sardines or mackerel', t: 'add', nutri: { srv: '3 oz', cal: 177, p: 20,  c: 0.0, f: 10 } },
  ],
  'Protein - Plant': [
    ...
    { n: 'Canned or dry green lentils', t: 'add', nutri: { srv: '½ cup cooked', cal: 115, p: 9.0, c: 20, f: 0.4, fi: 7.8 } },
  ],
  'Dairy and Refrigerated': [
    ...
    { n: 'Cream cheese - buy Neufchatel reduced-fat', t: 'swap', nutri: { srv: '1 oz',  cal: 70,  p: 3.0, c: 1.0, f: 6.5 } },
    { n: 'Cheddar small amount only',  t: 'swap', nutri: { srv: '1 oz',  cal: 113, p: 7.0, c: 0.4, f: 9.3 } },
    { n: 'Heavy cream',               t: 'remove' },
    { n: 'Kefir plain low-fat',       t: 'add', nutri: { srv: '1 cup',   cal: 110, p: 11,  c: 12,  f: 2.0 } },
    { n: 'Cottage cheese low-fat',    t: 'add', nutri: { srv: '½ cup',   cal: 90,  p: 12,  c: 5.0, f: 2.5 } },
  ],
  'Grains and Bread': [
    { n: 'Rolled oats or steel-cut oats',   nutri: { srv: '½ cup dry',  cal: 150, p: 5.0, c: 27,  f: 2.5, fi: 4.0 } },
    { n: 'Whole wheat rice',                nutri: { srv: '¼ cup dry',  cal: 160, p: 3.5, c: 35,  f: 1.5, fi: 2.0 } },
    { n: 'Low-carb flour tortillas - check for seed oils', t: 'swap', nutri: { srv: '1 tortilla', cal: 70, p: 5.0, c: 11, f: 3.0, fi: 8.0 } },
    { n: 'Pasta - swap for chickpea or lentil pasta Banza', t: 'swap', nutri: { srv: '2 oz dry', cal: 190, p: 13, c: 32, f: 3.0, fi: 8.0 } },
  ...
  'Nuts, Seeds and Fat': [
    ...
    { n: 'Pistachios',                 nutri: { srv: '1 oz (~49 nuts)',  cal: 160, p: 6.0, c: 8.0, f: 13,  fi: 3.0 } },
    { n: 'Macadamia nuts',             nutri: { srv: '1 oz (10-12 nuts)',cal: 204, p: 2.2, c: 3.9, f: 21,  fi: 2.4 } },
    { n: 'White sesame seeds',         nutri: { srv: '1 tbsp',           cal: 52,  p: 1.6, c: 2.1, f: 4.5, fi: 1.1 } },
    { n: 'PB2 powdered peanut butter', nutri: { srv: '2 tbsp',           cal: 45,  p: 5.0, c: 4.0, f: 1.5, fi: 1.0 } },
  ...
  'Oils and Condiments': [
    ...
    { n: 'Low-sodium soy sauce or tamari', nutri: { srv: '1 tbsp', cal: 10, p: 1.0, c: 1.0, f: 0.0 } },
    ...
    { n: "Pasta sauce 0g added sugar e.g. Rao's", t: 'swap', nutri: { srv: '½ cup', cal: 80, p: 2.0, c: 9.0, f: 5.0, fi: 2.0 } },
    { n: 'Mayo - avocado oil mayo Primal Kitchen',  t: 'swap', nutri: { srv: '1 tbsp', cal: 90, p: 0.0, c: 0.0, f: 10 } },
    { n: 'Cajeta',  t: 'remove' },
    { n: 'Lard',    t: 'remove' },
  ],
  ...
  'Baking': [
    { n: 'Baking powder' },
    { n: 'Baking soda' },
    { n: 'Cocoa powder unsweetened',   nutri: { srv: '1 tbsp', cal: 12,  p: 1.0, c: 3.0, f: 0.7, fi: 1.8 } },
    { n: 'Dark chocolate 70% bar small', nutri: { srv: '1 oz',  cal: 170, p: 2.0, c: 13,  f: 12,  fi: 3.0 } },
    { n: 'Chocolate chips',   t: 'remove' },
    { n: 'Powdered sugar',    t: 'remove' },
    { n: 'White sugar - small jar only', t: 'swap', nutri: { srv: '1 tsp', cal: 16, p: 0.0, c: 4.2, f: 0.0 } },
  ],
  'Supplements and Extras': [
    ...
    { n: 'Nutritional yeast',   t: 'add', nutri: { srv: '2 tbsp', cal: 40, p: 8.0, c: 3.0, f: 0.5, fi: 2.0 } },
