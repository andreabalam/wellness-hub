...
export const SCHEDULE_BLOCKS: ScheduleBlock[] = [
  {
    phase: 'Wake-up',
    time: '8:00',
    title: 'Wake + no-phone rule',
    dur: '5 min',
    dot: 'cg',
    why: 'wg',
    whyTxt: 'Protects cortisol awakening response',
  ...
  },
  {
    phase: 'Dog walk',
    time: '8:05',
    title: 'Dog walk — light exposure',
    dur: '10 min',
    dot: 'ct',
    why: 'wt',
    whyTxt: 'Circadian anchor + melatonin suppression',
  ...
  },
  {
    phase: 'Fuel up',
    time: '8:20',
    title: 'Hydration + breakfast',
    dur: '20 min',
    dot: 'ca',
    why: 'wa',
    whyTxt: 'Ghrelin peak + dopamine precursors',
  ...
  },
  {
    phase: 'Intention',
    time: '8:40',
    title: 'Meditation · Gratitude · Affirmations',
    dur: '18-20 min',
    dot: 'cgo',
    why: 'wgo',
    whyTxt: 'PFC priming · gratitude imprint · identity activation',
  ...
  },
  {
    phase: 'Activation',
    time: '9:00',
    title: 'Cold shower + skin care',
    dur: '15 min',
    dot: 'cp',
    why: 'wp',
    whyTxt: 'Norepinephrine spike → steady focus',
  ...
  },
  {
    phase: 'Commute',
    time: '9:15',
    title: 'Walk to office — planning walk',
    dur: '30 min',
    dot: 'ct',
    why: 'wt',
    whyTxt: 'BDNF + default mode network',
  ...
  },
  {
    phase: 'Ramp-up',
    time: '9:50',
    title: 'Caffeine — strategic timing',
    dur: '—',
    dot: 'ca',
    why: 'wa',
    whyTxt: 'Optimal adenosine clearance window',
  ...
  },
  {
    phase: null,
    time: '10:00',
    title: 'Daily planning block',
    dur: '15 min',
    dot: 'cp',
    why: 'wp',
    whyTxt: 'Decision reduction + implementation intentions',
  ...
  },
  {
    phase: null,
    time: '10:15',
    title: 'Warm-up work — low friction',
    dur: '45 min',
    dot: 'cgr',
    why: 'wgr',
    whyTxt: 'Synchrony effect — protect your peak',
  ...
  },
  {
    ...
    dot: 'cg',
    why: 'wg',
    whyTxt: 'Peak alpha/beta brainwave power',
  ...
  },
  {
    ...
    dot: 'ca',
    why: 'wa',
    whyTxt: 'Ultradian cycle completion',
  ...
  },
  {
    ...
    dot: 'cg',
    why: 'wg',
    whyTxt: 'Core temp peak + reaction time peak',
  ...
  },
  {
    phase: 'Evening',
    time: '9:00 PM',
    title: 'Brain dump + wind-down',
    dur: '30 min',
    dot: 'ct',
    why: 'wt',
    whyTxt: 'Rumination clearance + sleep-onset',
  ...
  },
  {
    ...
    dot: 'cgr',
    why: 'wgr',
    whyTxt: 'Eliminate morning decisions',
  ...
  },
  {
    ...
    dot: 'cp',
    why: 'wp',
    whyTxt: 'Non-negotiable — foundational to everything',
